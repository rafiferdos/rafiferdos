...
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=FF1CF7&center=true&vCenter=true&width=620&lines=𝐌𝐄𝐑𝐍-𝐒𝐭𝐚𝐜𝐤+𝐃𝐞𝐯𝐞𝐥𝐨𝐩𝐞𝐫+%7C+𝐅𝐮𝐥𝐥-𝐒𝐭𝐚𝐜𝐤+𝐖𝐞𝐛+𝐀𝐫𝐭𝐢𝐬𝐭;𝐁𝐮𝐢𝐥𝐝𝐢𝐧𝐠+𝐝𝐢𝐠𝐢𝐭𝐚𝐥+𝐞𝐱𝐩𝐞𝐫𝐢𝐞𝐧𝐜𝐞𝐬+𝐭𝐡𝐚𝐭+𝐢𝐧𝐬𝐩𝐢𝐫𝐞+%26+𝐞𝐧𝐠𝐚𝐠𝐞;𝐂𝐫𝐚𝐟𝐭𝐢𝐧𝐠+𝐢𝐧𝐭𝐮𝐢𝐭𝐢𝐯𝐞+𝐔𝐈𝐬+𝐰𝐢𝐭𝐡+𝐦𝐨𝐝𝐞𝐫𝐧+𝐰𝐞𝐛+𝐭𝐞𝐜𝐡𝐧𝐨𝐥𝐨𝐠𝐢𝐞𝐬" alt="Typing SVG" />
</div>

<br/>

> _"I transform ideas into elegant, user-focused digital experiences through clean, maintainable code and innovative design."_
...
<div align="center">
  <img width="49%" src="https://github-readme-streak-stats.herokuapp.com?user=rafiferdos&theme=radical&hide_border=true&background=0D1117&stroke=0D1117&fire=FF1CF7&sideLabels=00F0FF&currStreakNum=FF1CF7&ring=FF1CF7&currStreakLabel=FF1CF7&sideNums=00F0FF" />
  <img width="49%" src="https://github-readme-stats.vercel.app/api?username=rafiferdos&show_icons=true&theme=radical&hide_border=true&count_private=true" />
</div>
<div align="center">
  <img width="40%" src="https://github-readme-stats.vercel.app/api/top-langs/?username=rafiferdos&layout=donut&theme=radical&hide_border=true" />
</div>
...
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| **Nebula Clash**   | A full-stack contest platform with role-based access control, featuring contest creation, user participation, and winner selection systems with a dynamic leaderboard. | React, Firebase, Express.js, Node.js, MongoDB, TailwindCSS | [🌐 Live](https://nebula-clash.web.app/) [💻 GitHub](https://github.com/rafiferdos/nebula-clash/)    |
| **Swap Savvy**     | An interactive platform for exploring and contributing to a database of alternative product information, with search and recommendation capabilities.                  | React, Firebase, Express.js, Node.js, MongoDB, TailwindCSS | [🌐 Live](https://swapsavvy-4bd63.web.app/) [💻 GitHub](https://github.com/rafiferdos/swap_savvy/)   |
| **Canvas Whisper** | A CRUD application with user authentication that enables protected routes and interaction with a database for managing personal crafts.                                | React, Firebase, Express.js, JWT, TailwindCSS              | [🌐 Live](https://canvas-whisper.web.app/) [💻 GitHub](https://github.com/rafiferdos/canvas-whisper) |
