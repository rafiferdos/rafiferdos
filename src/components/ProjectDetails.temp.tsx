  ...
  return (
    ...
    >
      ...
      <Spotlight
        ...
        fill={theme === 'dark' ? 'rgba(30, 64, 175, 0.15)' : 'rgba(59, 130, 246, 0.15)'}
      />
      ...
      <div className='max-w-4xl mx-auto px-4 sm:px-6 relative z-10'>
        ...
        >
          ...
          <h1 className={`text-3xl sm:text-4xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r ${
            theme === 'dark' 
          ...
          <div className='grid grid-cols-1 md:grid-cols-12 gap-8'>
            ...
            <div className='md:col-span-8 order-2 md:order-1'>
              ...
              <section className='mb-10'>
                <h2 className={`text-xl font-bold mb-4 ${theme === 'dark' ? 'text-blue-400' : 'text-blue-600'}`}>
                  Overview
                </h2>
                <div className={`rounded-lg p-6 backdrop-blur-sm ${
                  theme === 'dark' ? 'bg-gray-900/30 border border-gray-800' : 'bg-gray-50/70 border border-gray-200'
                }`}>
                  ...
                  <div className={`rounded-lg p-6 backdrop-blur-sm ${
                    ...
                    <ul className='space-y-3'>
                      {project.features.map((feature, index) => (
                        ...
                        >
                          <span className={`inline-flex items-center justify-center rounded-full h-6 w-6 min-w-6 mr-3 mt-0.5 text-xs ${
