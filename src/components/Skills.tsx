...
const Skills = () => {
  ...
  const words =
    "My technical toolkit includes expertise in essential front-end technologies like HTML, CSS, and JavaScript, along with modern frameworks like React, Next.js, and TypeScript.";
